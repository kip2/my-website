        ...
        <>
            <section className="flex justify-between py-5">
                ...
                <div className="grid grid-cols-3 gap-2">
                    <Link to="/" className="grid justify-items-center text-xs hover:scale-110 transition-transform duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="48" height="48" className="hover:scale-110 transition-transform duration-300">
                    ...
                    <Link to="/about" className="grid justify-items-center text-xs hover:scale-110 transition-transform duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="48" height="48" className="hover:scale-110 transition-transform duration-300">
                            <rect width="256" height="256" fill="none"/>
                    ...
                    <Link to="/products" className="grid justify-items-center text-xs hover:scale-110 transition-transform duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="48" height="48" className="hover:scale-110 transition-transform duration-300">
                            <rect width="256" height="256" fill="none"/>
