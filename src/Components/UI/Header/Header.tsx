    ...
    return (
        <>
            <section className="flex justify-between max-md:justify-center pt-5 pb-3">
                ...
                <div className={`fixed top-0 left-0 h-full bg-slate-900 opacity-85 shadow-md px-3 transition-transform duration-300 z-10 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
